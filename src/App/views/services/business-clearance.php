...
<main class="container-fluid flex-grow-1 py-2 login-main">
    <div class="row mt-2 pb-2 px-5 mx-5 gy-3 shadow-lg rounded-3 bg-light bg-opacity-50 position-relative">
        ...
        <h6 class="display-6 text-center" style="font-size: 2rem;">Business Clearance</h6>
        <div class="row mt-5 pb-3 px-0">
                    ...
                    <tbody>
                        <?php foreach ($records as $record) : ?>
                            <tr>
                                ...
                                <td><?= convertToDateFormat(e($record['bnc_date_time'])); ?></td>
                                <td><?= convertToTimeFormat(e($record['bnc_date_time'])); ?></td>
                                <td><?= e($record['bnc_business']); ?></td>
                                ...
                                <td class="justify-content-center gap-2 d-flex justify-content-center align-items-center">
                                    <a href="business-clearance/<?= e($record['bnc_id']); ?>" class="col text-decoration-none text-white flex">
                                    ...
                                    <div class="col text-white flex">
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal<?= e($record['bnc_id']); ?>" class="btn btn-light p-0 h-100 w-100 d-flex align-items-center justify-content-center gap-2 px-2 py-1" style="font-size: 0.8rem;">
                            ...
                            <div class="modal fade" id="deleteModal<?= e($record['bnc_id']); ?>" aria-hidden="true" aria-labelledby="deleteModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer px-2">
                                            <form action="business-clearance/<?= e($record['bnc_id']); ?>" method="POST">
            ...
            <div class="col">
                ...
                <form method="POST" id="BNC_applicationForm" novalidate>
                    <?php include $this->resolve('partials/_csrf.php'); ?>
                    ...
                    <div class="mt-2 row">
                        <label for="applicant-business" class="col-4 col-form-label">Business Name</label>
                        <div class="col">
                            <input type="text" class="form-control" id="applicant-business" name="applicant-business" required>
                        </div>
                    </div>
                    <div class="mt-2 row">
                        <label for="issue-or" class="col-4 col-form-label">OR No.</label>
                        <div class="col">
                            <input type="text" class="form-control" id="issue-or" name="issue-or" required>
                        </div>
                    </div>
                    <div class="mt-2 row">
                        <label for="issue-date" class="col-4 col-form-label">Issued on</label>
                        <div class="col">
                            <input type="date" class="form-control" id="issue-date" name="issue-date" value="<?= date('Y-m-d'); ?>" required>

                        </div>
                    </div>
                    <div class="mt-2 row">
                        <label for="issue-amount" class="col-4 col-form-label">Amount paid</label>
                        <div class="col">
                            <input type="number" class="form-control" id="issue-amount" name="issue-amount" required>
                        </div>
                    </div>
                    <div class="mt-2 row">
                        <label for="issue-number" class="col-4 col-form-label">BC #</label>
                        <div class="col d-flex align-items-center gap-2">
                            <h6 class="mb-0 text-primary-emphasis"><?= date("Y"); ?>-</h6><input type="text" class="form-control" id="issue-number" name="issue-number" required>
                        </div>
                    </div>
                    <div class="mt-2 row">
                    ...
                    <div class="mt-4 row">
                        <button type="button" id="BNC-submit" class="btn btn-dark d-flex gap-3 justify-content-center align-items-center py-2">
...
<script>
    ...
    const businessName = document.getElementById("applicant-business");
    const issueOR = document.getElementById("issue-or");
    ...
    const applicantForm = document.getElementById("BNC_applicationForm");
    const submitBtn = document.getElementById("BNC-submit");
                ...
                try {
                    ...
                    data.residents?.forEach(resident => {
                        ...
                        button.addEventListener("click", () => {
                            ...
                            issueOR.classList.remove("is-invalid");
    ...
    submitBtn.addEventListener("click", () => {
        if (applicantName.value === null || applicantName.value == "") {
            ...
            if (businessName.value === null || businessName.value == "") {
                ...
                if (issueOR.value === null || issueOR.value == "") {
                    issueOR.classList.add("is-invalid");
                    return;
                } else {
                    if (issueAmount.value === null || issueAmount.value == "") {
                        issueAmount.classList.add("is-invalid");
                        return;
                    } else {
                        if (issueNumber.value === null || issueNumber.value == "") {
                            issueNumber.classList.add("is-invalid");
                            return;
                        } else {
