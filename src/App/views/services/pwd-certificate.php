...
<main class="container-fluid flex-grow-1 py-2 login-main">
    <div class="row mt-2 pb-2 px-5 mx-5 gy-3 shadow-lg rounded-3 bg-light bg-opacity-50 position-relative">
        ...
        <h6 class="display-6 text-center" style="font-size: 2rem;">PWD Certificate</h6>
        <div class="row mt-5 pb-3 px-0">
                    ...
                    <tbody>
                        <?php foreach ($records as $record) : ?>
                            <tr class="cursor-pointer">
                                ...
                                <td><?= convertToDateFormat(e($record['pwd_date_time'])); ?></td>
                                <td><?= convertToTimeFormat(e($record['pwd_date_time'])); ?></td>
                                <td><?= e($record['pwd_condition']); ?></td>
                                ...
                                <td class="justify-content-center gap-2 d-flex justify-content-center align-items-center">
                                    <a href="pwd-certificate/<?= e($record['pwd_id']); ?>" class="col text-decoration-none text-white flex">
                                    ...
                                    <div class="col text-white flex">
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#deleteModal<?= e($record['pwd_id']); ?>" class="btn btn-light p-0 h-100 w-100 d-flex align-items-center justify-content-center gap-2 px-2 py-1" style="font-size: 0.8rem;">
                            ...
                            <div class="modal fade" id="deleteModal<?= e($record['pwd_id']); ?>" aria-hidden="true" aria-labelledby="deleteModal">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer px-2">
                                            <form action="pwd-certificate/<?= e($record['pwd_id']); ?>" method="POST">
            ...
            <div class="col">
                ...
                <form method="POST" id="PWD_applicationForm" novalidate>
                    <?php include $this->resolve('partials/_csrf.php'); ?>
                    ...
                    <div class="mt-2 row">
                        <label for="applicant-condition" class="col-4 col-form-label">Condition</label>
                        <div class="col">
                            <input type="text" class="form-control" id="applicant-condition" name="applicant-condition" required>
                        </div>
                    </div>
                    <div class="mt-2 row">
                    ...
                    <div class="mt-4 row">
                        <button type="button" id="PWD_submitBtn" class="btn btn-dark d-flex gap-3 justify-content-center align-items-center py-2">
...
<script>
    ...
    const applicantCondition = document.getElementById("applicant-condition");
    const punongBarangay = document.getElementById("punong-barangay");
    const applicantForm = document.getElementById("PWD_applicationForm");
    const submitBtn = document.getElementById("PWD_submitBtn");
                ...
                try {
                    ...
                    data.residents?.forEach(resident => {
                        ...
                        button.addEventListener("click", () => {
                            ...
                            applicantCondition.classList.remove("is-invalid");
    ...
    submitBtn.addEventListener("click", () => {
        if (applicantName.value === null || applicantName.value == "") {
            ...
            if (applicantCondition.value === null || applicantCondition.value == "") {
                applicantCondition.classList.add("is-invalid");
                return;
            } else {
